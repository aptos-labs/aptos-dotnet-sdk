...
public class EventData(string accountAddress, long creationNumber, JsonElement? data, long eventIndex, decimal sequenceNumber, long transactionBlockHeight, decimal transactionVersion, string type, string indexedType)
{

    public EventData(IEventData eventData) : this(
