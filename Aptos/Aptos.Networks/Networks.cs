...
{
    public static readonly NetworkConfig Devnet =
        new(
            "devnet",
    ...
    public static readonly NetworkConfig Testnet =
        new(
            "testnet",
    ...
    public static readonly NetworkConfig Mainnet =
        new(
            "mainnet",
    ...
    public static readonly NetworkConfig Local =
        new(
            "local",
