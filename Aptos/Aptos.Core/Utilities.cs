...
namespace Aptos.Core
{
    public static class Utilities
    {
        ...
        public static (
            ...
            string moduleName,
            string functionName
        ) ParseFunctionParts(string function)
        {
            string[] parts = function.Split("::");
            if (parts.Length != 3)
                throw new ArgumentException($"Invalid function format {function}");
        ...
        public static List<TypeTag> StandardizeTypeTags(List<object> typeTags) =>
            typeTags
                .Select(t =>
                    t is string stringTag ? TypeTag.Parse(stringTag)
            ...
            where T : class
        {
            ...
            if (vec is JArray arr && arr.Count > 0)
                return JsonConvert.DeserializeObject<T>(JsonConvert.SerializeObject(arr.First()));
            return null;
        }
        ...
        public static byte[] HexStringToBytes(string hexString)
        {
            ...
            return Enumerable
                .Range(0, formattedString.Length)
                .Where(x => x % 2 == 0)
        ...
        public static string HexStringToString(string hexString) =>
            Encoding.ASCII.GetString(HexStringToBytes(hexString));
