...
public partial class MultiKey : PublicKey
{
    ...
    public MultiKey(List<PublicKey> publicKeys, byte signaturesRequired) : base(PublicKeyVariant.MultiKey)
    {
    ...
    {
        List<PublicKey> publicKeys = d.Vector(PublicKey.Deserialize).Cast<PublicKey>().ToList();
...
public class MultiKeySignature : Signature
{
    ...
    public MultiKeySignature(List<Signature> signatures, byte[] bitmap) : base(SignatureVariant.MultiKey)
    {
    ...
    {
        List<Signature> signatures = d.Vector(Signature.Deserialize).Cast<Signature>().ToList();
        byte[] bitmap = d.Bytes();
