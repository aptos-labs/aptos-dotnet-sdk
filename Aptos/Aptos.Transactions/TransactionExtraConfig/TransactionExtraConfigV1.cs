...
public class TransactionExtraConfigV1(AccountAddress? multiSigAddress = null, ulong? replayProtectionNonce = null) : TransactionExtraConfig
{
    ...
    public override void Serialize(Serializer s)
    {
        ...
        new MoveOption<U64>(ReplayProtectionNonce.HasValue ? new U64(ReplayProtectionNonce.Value) : null).Serialize(s);
    }

    public static new TransactionExtraConfigV1 Deserialize(Deserializer d)
    {
        var multiSigAddress = MoveOption<AccountAddress>.Deserialize(d, AccountAddress.Deserialize).Value;
