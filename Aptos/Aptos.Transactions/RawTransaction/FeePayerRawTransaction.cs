...
public class FeePayerRawTransaction(
    RawTransaction rawTransaction,
    List<AccountAddress> secondarySignerAddresses,
    AccountAddress feePayerAddress
) : RawTransactionWithData(rawTransaction, feePayerAddress, secondarySignerAddresses)
{
    ...
    public static new FeePayerRawTransaction Deserialize(Deserializer d) =>
        new(
            RawTransaction.Deserialize(d),
            [.. d.Vector(AccountAddress.Deserialize)],
